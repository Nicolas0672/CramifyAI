        ...
        <>
            ...
            >
                ...
                <div className='flex gap-2 items-center'>
                    ...
                    {/* Title */}
                    {isSidebarExpanded && <h2 className='font-bold text-2xl text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 tracking-tight'>CramifyAI</h2>}

                    {/* Hamburger Menu */}
                    <div
                        className='p-2 bg-white/90 backdrop-blur-sm rounded-full shadow-lg cursor-pointer transition-all hover:bg-indigo-50 hover:rotate-180 duration-300'
                        onClick={() => setIsSidebarExpanded(!isSidebarExpanded)}
                    >
                        <Menu className="w-6 h-6 text-indigo-600" />
                    </div>
