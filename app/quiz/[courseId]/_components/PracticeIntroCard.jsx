        ...
        <div className='flex-1'>
          ...
          <motion.div variants={itemVariants} className="mb-3">
            <h2 className='font-bold text-2xl bg-gradient-to-r from-blue-700 to-indigo-700 bg-clip-text text-transparent'>
              {course?.aiResponse?.quizTitle || "Interactive Quiz Session"}
            </h2>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mb-5">
            <p className='text-gray-600 leading-relaxed'>
              {course?.aiResponse?.learningObjectives || "Enhance your knowledge with these interactive quizzes designed to test and improve your understanding."}
            </p>
          </motion.div>
