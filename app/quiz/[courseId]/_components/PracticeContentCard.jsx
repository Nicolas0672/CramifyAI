...
import { ArrowRight, RefreshCcw, Sparkles, CheckCircle, XCircle, Loader2 } from 'lucide-react';
      ...
      >
        ...
        <div className="flex flex-col items-center z-10 w-full h-full">
          ...
          <motion.div initial={{ y: -10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.1 }}>
            ...
            ) : quizTypeContent?.[item.type]?.status == 'Generating' || loading ? (
          ...
          <motion.div className="w-full mt-auto" whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
            {isReady ? (
              ...
              <Button
                className="cursor-pointer w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-0 hover:from-blue-600 hover:to-indigo-700 shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 py-4 sm:py-5"
                disabled={true}
              >
