    ...
    return (
        <div className='h-screen shadow-md p-5 bg-white'>
            ...
            <div className='flex gap-2 items-center'>
                ...
                <h2 className='font-bold text-2xl text-gray-800'>CramifyAI</h2>
            </div>
            ...
            {/* Credits Section */}
            <div className='w-[88%] absolute bottom-10 border p-4 bg-blue-50 rounded-lg shadow-sm'>
                <h2 className='text-lg mb-2 text-gray-800'>Available Credits:</h2>
