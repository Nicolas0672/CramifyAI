...
import { LayoutDashboard, Shield, UserCircle, Menu, BookOpen, Brain, Sparkles, Loader2Icon, XCircle, CheckCircle, AlertTriangle, Info } from 'lucide-react'; // Added education/AI themed icons
                            ...
                            <div className="h-[calc(100vh-68px)] overflow-y-auto p-4 bg-gradient-to-br from-white via-blue-50 to-indigo-50 border-r border-blue-100/50 shadow-xl">
                                ...
                                <div className='mt-4'>
                                    ...
                                    <Button
                                        ...
                                        onClick={() => showErrorToast('You have run out of credits')}
                                    >
