...
export async function POST(req){
    ...
    switch (eventType) {
      case 'checkout.session.completed':
        ...
        const transactionId = data.object.payment_intent; // This is the transaction ID
        ...
        const updatePaymentTable = await db.insert(PAYMENT_USER_TABLE).values({
            ...
            amountPaid: data.object.amount_total / 100, // Convert cents to dollars
            status: data.object.payment_status,
            creditAmount: 20, // Adjust based on purchase
